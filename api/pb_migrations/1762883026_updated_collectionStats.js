...
migrate((app) => {
  ...
  // remove field
  collection.fields.removeById("_clone_lsl5")

  // remove field
  collection.fields.removeById("_clone_xYZe")

  // remove field
  collection.fields.removeById("_clone_a4Pg")

  // remove field
  collection.fields.removeById("_clone_absz")

  // remove field
  collection.fields.removeById("_clone_OB6u")
