...
migrate((app) => {
  ...
  // remove field
  collection.fields.removeById("_clone_rJTO")

  // remove field
  collection.fields.removeById("_clone_Ruqx")

  // remove field
  collection.fields.removeById("_clone_89rU")

  // remove field
  collection.fields.removeById("_clone_kBEy")

  // remove field
  collection.fields.removeById("json542828193")
